...
- `microhack/participant/pre-work-checklist.md` (absorbed into `docs/getting-started.md`)
- `microhack/participant/scenario-brief.md` (merged into `docs/workshop-prep.md`)
...
- `microhack/participant/team-role-cards.md` (merged into `docs/workshop-prep.md`)
- `microhack/participant/quota-requirements.md` (merged into `docs/getting-started.md`)
