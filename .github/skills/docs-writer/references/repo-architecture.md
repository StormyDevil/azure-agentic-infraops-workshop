...
| `getting-started.md`      | Setup, dev container, quotas, and first run (merged from quickstart, know-before-you-go, dev-containers, quota-requirements) |
| `workshop-prep.md`        | Nordic Fresh Foods scenario + team role cards (merged from scenario-brief, team-role-cards)                                  |
...
| `guides/contributing.md`  | Git workflow, commits, versioning (merged from development-workflow, automated-versioning)                                   |
